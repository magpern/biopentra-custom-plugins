...
if ( ! function_exists( 'biopentra_mini_cart_drawer_render_item' ) ) {
	...
	function biopentra_mini_cart_drawer_render_item( $cart_item_key, $cart_item ) {
		...
		?>
		<div class="elementor-menu-cart__product woocommerce-mini-cart-item mini_cart_item woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
			...
			<div class="elementor-menu-cart__product-name product-name product-data" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
				<?php
				if ( ! $product_permalink ) {
			...
			<div class="elementor-menu-cart__product-price product-price ct-product-actions" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
				<?php
