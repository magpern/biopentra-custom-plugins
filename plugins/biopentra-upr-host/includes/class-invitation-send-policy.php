...
final class Biopentra_Upr_Host_Invitation_Send_Policy {
	...
	public static function evaluate_pilot( array $context ): array {
		if ( ! Biopentra_Upr_Host_Options::pilot_invitation_sending_authorised() ) {
			return array(
		...
		$allowed  = Biopentra_Upr_Host_Options::pilot_order_id_allowlist();
