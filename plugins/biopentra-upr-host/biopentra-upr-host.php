...
if ( defined( 'WP_CLI' ) && WP_CLI ) {
	...
	require_once BIOPENTRA_UPR_HOST_PATH . 'cli/class-verify-native-submit-dev-command.php';
	...
	WP_CLI::add_command( 'biopentra-upr-host verify-native-submit-dev', 'Biopentra_Upr_Host_Verify_Native_Submit_Dev_Command' );
}
