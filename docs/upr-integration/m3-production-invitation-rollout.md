...
> **Ownership correction (2026-08-27):** Production host package target is no longer `biopentra-upr-host` **0.1.5**. Future target is standalone [`upr-host-adapter`](https://github.com/magpern/upr-host-adapter) **`v0.1.1`**. See [`upr-host-adapter-ownership-addendum.md`](upr-host-adapter-ownership-addendum.md). Production remains **NO-GO**; no production deploy has occurred.
